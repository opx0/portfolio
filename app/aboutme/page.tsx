...
export default function AboutPage() {
  return (
    <div className="w-full max-w-4xl mx-auto px-6 pt-24 pb-16">
      ...
      <Link
        href="/"
        className="inline-flex items-center gap-1.5 text-xs text-[var(--text-muted)] hover:text-[var(--text-primary)] transition-colors mb-10 animate-fade-in-up"
      >
      ...
      {/* ═══════════════════════════════════════════
          HERO SECTION
      ═══════════════════════════════════════════ */}
      <section className="mb-24 animate-fade-in-up animate-delay-1">
        {/* Avatar + Name badge */}
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-24 animate-fade-in-up animate-delay-2">
      ...
      {/* ═══════════════════════════════════════════
          STACK SECTION
      ═══════════════════════════════════════════ */}
      <section className="mb-24 animate-fade-in-up animate-delay-3">
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-24 animate-fade-in-up animate-delay-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
              ...
              — complete platforms with real users.
            </p>
          </div>
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
              ...
              in Go — a developer productivity suite. Deep Arch Linux and
          ...
          <div>
            ...
            <p className="text-sm text-[var(--text-secondary)] leading-relaxed">
              Core Web Vitals optimization, efficient state management, and
              server-side rendering. Every millisecond counts in delivering a
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-24 animate-fade-in-up animate-delay-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="project-card">
            ...
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed mb-4">
              AI-powered course generation platform with streaming, interactive
              lessons, and a teaching assistant.
            </p>
            <div className="flex flex-wrap gap-1.5 mb-4">
              {["TypeScript", "Next.js", "AI"].map((t) => (
                <span
                  key={t}
                  className="px-2 py-0.5 rounded-md bg-[var(--bg)] text-[0.625rem] font-medium text-[var(--text-muted)]"
                >
                  {t}
                </span>
              ))}
            ...
            <div className="flex gap-3">
              <a
                href="https://ai-tutor-sepia.vercel.app"
                target="_blank"
              ...
              <a
                href="https://github.com/opx0/ai-tutor"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link text-xs"
              >
          ...
          <div className="project-card">
            ...
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed mb-4">
              Developer productivity CLI built in Go. Project scaffolding,
              workflow automation, and system utilities.
            </p>
            <div className="flex flex-wrap gap-1.5 mb-4">
            ...
            <div className="flex gap-3">
              <a
                href="https://github.com/opx0/dev-cli"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link text-xs"
              >
          ...
          <div className="project-card">
            ...
            <p className="text-xs text-[var(--text-secondary)] leading-relaxed mb-4">
              AI-powered market analysis tool for competitive research,
            ...
            <div className="flex gap-3">
              <a
                href="https://market-research-zeta.vercel.app"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link text-xs"
              >
              ...
              <a
                href="https://github.com/opx0/market-research-assistent"
                target="_blank"
                rel="noopener noreferrer"
                className="social-link text-xs"
              >
      ...
      ═══════════════════════════════════════════ */}
      <section className="mb-24 animate-fade-in-up animate-delay-7">
      ...
      {/* ═══════════════════════════════════════════
          CTA SECTION
      ═══════════════════════════════════════════ */}
      <section className="text-center py-16 animate-fade-in-up animate-delay-5">
