  ...
  return (
    <div className="w-full max-w-4xl mx-auto px-6 pt-24 pb-16">
      ...
      <section id="about" className="mb-24 scroll-mt-20">
        ...
        {/* Main heading */}
        <h1 className="text-5xl md:text-6xl font-light leading-[1.1] tracking-tight mb-8 animate-fade-in-up animate-delay-1">
          FullStack
          <br />
          Engineer
          <br />
        ...
        {/* Intro paragraph */}
        <p className="max-w-md text-[var(--text-secondary)] text-base leading-relaxed mb-8 animate-fade-in-up animate-delay-2">
        ...
        {/* Social links */}
        <div className="flex items-center gap-5 animate-fade-in-up animate-delay-3">
          <a
      ...
      ═══════════════════════════════════════════ */}
      <section id="approach" className="mb-24 scroll-mt-20 animate-fade-in-up animate-delay-2">
      ...
      {/* ═══════════════════════════════════════════
          STACK SECTION
      ═══════════════════════════════════════════ */}
      <section id="stack" className="mb-24 scroll-mt-20 animate-fade-in-up animate-delay-3">
      ...
      ═══════════════════════════════════════════ */}
      <section id="projects" className="mb-24 scroll-mt-20 animate-fade-in-up animate-delay-4">
      ...
      {/* ═══════════════════════════════════════════
          CTA SECTION
      ═══════════════════════════════════════════ */}
      <section id="contact" className="text-center py-16 scroll-mt-20 animate-fade-in-up animate-delay-5">
